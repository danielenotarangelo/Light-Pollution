export default function Header({ variable, onVariableChange, dark, onToggleTheme, globeTexture, onToggleGlobeTexture }) {
  const toggles = [
    { key: 'r',      label: 'Light'  },
    { key: 'g',      label: 'Wealth' },
  ...
  return (
    <header>
      ...
      <div className="head-right">
        ...
        <button className="theme-btn" title={globeTexture ? 'Switch to dark globe' : 'Switch to satellite view'} onClick={onToggleGlobeTexture}>
          {globeTexture ? (
